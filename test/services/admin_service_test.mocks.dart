...
// in ugrak_mekan_app/test/services/admin_service_test.dart.
...
class _FakePostgrestTransformBuilder_18<T1> extends _i1.SmartFake
  ...
  _FakePostgrestTransformBuilder_18(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeResponsePostgrestBuilder_19<T1, S, R> extends _i1.SmartFake
    implements _i2.ResponsePostgrestBuilder<T1, S, R> {
  _FakeResponsePostgrestBuilder_19(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockPostgrestFilterBuilder<T> extends _i1.Mock
  ...
  _i2.PostgrestTransformBuilder<Map<String, dynamic>> single() =>
      (super.noSuchMethod(
            ...
            returnValue:
                _FakePostgrestTransformBuilder_18<Map<String, dynamic>>(
                  this,
                  Invocation.method(#single, []),
                ),
          )
